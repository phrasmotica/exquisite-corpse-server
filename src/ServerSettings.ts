...
export class ServerSettings {
     ...
     */
    private static readonly DEFAULT_ROOM_NAMES = ["Caciatore's"]
     ...
     */
    private static readonly DEFAULT_MAX_PLAYERS_PER_ROOM = 2

    /**
     * The default maximum number of spectators allowed in a single room.
     */
    private static readonly DEFAULT_MAX_SPECTATORS_PER_ROOM = 2
